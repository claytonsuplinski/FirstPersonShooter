...
void Shader2::CommonSetup(const float time, const GLint * size, const GLfloat * projection, const GLfloat * modelview, const GLfloat * mvp, const GLfloat * nm)
{
...
bool Shader2::Initialize(char * vertex_shader_file, char * fragment_shader_file)
{
	GLint check_value;

	if (GLReturnedError("Shader2::Initialize - on entrance"))
		return false;
	...
	return !GLReturnedError("Shader2::Initialize - on exit");
}

void Shader2::CustomSetup()
{
}

//If we want to dynamically change the color and opacity of the object
void Shader2::CustomSetup2(vec4 color)
{
...
bool Shader2::LoadShader(const char * file_name, GLuint shader_id)
{
	assert(file_name != NULL);
	if (GLReturnedError("Shader2::LoadShader - on entrance"))
		return false;
	...
	return !GLReturnedError("Shader2::LoadShader - on exit");
}

stringstream Shader2::GetShaderLog(GLuint shader_id)
{
	stringstream s;
	GLint log_length;
...
bool Shader2::GLReturnedError(char * s)
{
